...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SHAHID PRIME SERVICES — International Visas & Saudi Services" },
      { name: "description", content: "Your trusted partner for Schengen, Study, Umrah visas and Saudi Khidmat services. Expert consultation, high approval rate, personalized support." },
      { property: "og:title", content: "SHAHID PRIME SERVICES — International Visas & Saudi Services" },
      { property: "og:description", content: "Trusted visa consultants for Schengen, Study, Umrah, and Saudi Khidmat services." },
