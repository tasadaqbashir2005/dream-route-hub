    ...
    >
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8 lg:py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5 text-[#D4AF37]"><path d="M12 2 4 5v6c0 5 3.5 9.5 8 11 4.5-1.5 8-6 8-11V5l-8-3Z"/><path d="m9 12 2 2 4-4"/></svg>
            <span className="tracking-wide">CR <span className="font-bold">7052788051</span></span>
          </div>
          <a
          ...
          >
            <nav className="flex flex-col gap-1">
              ...
              <div className="mt-3 flex items-center justify-center gap-2 rounded-full border border-[#D4AF37]/60 bg-gradient-to-r from-[#D4AF37]/15 to-[#D4AF37]/5 px-3 py-2 text-xs font-semibold text-[#0B2545]">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-[#D4AF37]"><path d="M12 2 4 5v6c0 5 3.5 9.5 8 11 4.5-1.5 8-6 8-11V5l-8-3Z"/><path d="m9 12 2 2 4-4"/></svg>
                <span>Officially Registered — CR <span className="font-bold">7052788051</span></span>
              </div>
              <a
                href={`tel:+${WHATSAPP_NUMBER}`}
